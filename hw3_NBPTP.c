...
int main(int argc, char **argv) {
    ...
    while (currGen < maxGen && changeDetected == 1) {
        ...
        //Manual handling of ghost cells
        ...
        //Perform a global logical OR reduction to determine if any process has detected a change,
        // allowing all processes to decide uniformly whether to continue.
